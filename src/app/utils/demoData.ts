...
export const DEMO_EMPLOYEES: Employee[] = [
  { id: "EMP-001", name: "Raj Patel", initials: "RP", color: COLORS[0], department: "Engineering", designation: "Senior Associate", salary: "₹7,50,000", bracket: "₹5L – ₹8L", benefitPlan: "Senior Associate", status: "active", email: "raj.patel@acme.com", phone: "9876543210", location: "Mumbai" },
  { id: "EMP-002", name: "Priya Sharma", initials: "PS", color: COLORS[1], department: "Human Resources", designation: "Associate", salary: "₹4,50,000", bracket: "₹2.5L – ₹5L", benefitPlan: "Associate", status: "active", email: "priya.sharma@acme.com", phone: "9876543211", location: "Bengaluru" },
  { id: "EMP-003", name: "Arjun Singh", initials: "AS", color: COLORS[2], department: "Engineering", designation: "Senior Manager", salary: "₹15,00,000", bracket: "₹12L – ₹18L", benefitPlan: "Senior Manager", status: "active", email: "arjun.singh@acme.com", phone: "9876543212", location: "Delhi" },
  { id: "EMP-004", name: "Sneha Gupta", initials: "SG", color: COLORS[3], department: "Product", designation: "Manager", salary: "₹10,00,000", bracket: "₹8L – ₹12L", benefitPlan: "Manager", status: "active", email: "sneha.gupta@acme.com", phone: "9876543213", location: "Hyderabad" },
  { id: "EMP-005", name: "Vikram Reddy", initials: "VR", color: COLORS[4], department: "Sales", designation: "AVP", salary: "₹20,00,000", bracket: "₹18L – ₹25L", benefitPlan: "AVP", status: "active", email: "vikram.reddy@acme.com", phone: "9876543214", location: "Chennai" },
  { id: "EMP-006", name: "Anita Desai", initials: "AD", color: COLORS[5], department: "Finance", designation: "Manager", salary: "₹9,50,000", bracket: "₹8L – ₹12L", benefitPlan: "Manager", status: "active", email: "anita.desai@acme.com", phone: "9876543215", location: "Mumbai" },
  { id: "EMP-007", name: "Karthik Iyer", initials: "KI", color: COLORS[6], department: "Engineering", designation: "Associate", salary: "₹4,20,000", bracket: "₹2.5L – ₹5L", benefitPlan: "Associate", status: "active", email: "karthik.iyer@acme.com", phone: "9876543216", location: "Bengaluru" },
  { id: "EMP-008", name: "Meera Joshi", initials: "MJ", color: COLORS[7], department: "Marketing", designation: "Senior Associate", salary: "₹6,80,000", bracket: "₹5L – ₹8L", benefitPlan: "Senior Associate", status: "active", email: "meera.joshi@acme.com", phone: "9876543217", location: "Pune" },
  { id: "EMP-009", name: "Rohit Dalal", initials: "RD", color: COLORS[8], department: "Operations", designation: "Senior Associate", salary: "₹6,00,000", bracket: "₹5L – ₹8L", benefitPlan: "Senior Associate", status: "active", email: "rohit.dalal@acme.com", phone: "9876543218", location: "Gurugram" },
  { id: "EMP-010", name: "Deepika Nair", initials: "DN", color: COLORS[9], department: "Engineering", designation: "Senior Associate", salary: "₹7,00,000", bracket: "₹5L – ₹8L", benefitPlan: "Senior Associate", status: "active", email: "deepika.nair@acme.com", phone: "9876543219", location: "Kochi" },
  { id: "EMP-011", name: "Amit Verma", initials: "AV", color: COLORS[10], department: "Engineering", designation: "Manager", salary: "₹10,50,000", bracket: "₹8L – ₹12L", benefitPlan: "Manager", status: "active", email: "amit.verma@acme.com", phone: "9876543220", location: "Noida" },
  { id: "EMP-012", name: "Lakshmi Pillai", initials: "LP", color: COLORS[11], department: "Legal", designation: "Senior Manager", salary: "₹14,00,000", bracket: "₹12L – ₹18L", benefitPlan: "Senior Manager", status: "active", email: "lakshmi.pillai@acme.com", phone: "9876543221", location: "Mumbai" },
  { id: "EMP-013", name: "Sanjay Mehta", initials: "SM", color: COLORS[12], department: "Sales", designation: "Associate", salary: "₹3,80,000", bracket: "₹2.5L – ₹5L", benefitPlan: "Associate", status: "active", email: "sanjay.mehta@acme.com", phone: "9876543222", location: "Ahmedabad" },
  { id: "EMP-014", name: "Nisha Kapoor", initials: "NK", color: COLORS[13], department: "Design", designation: "Senior Associate", salary: "₹7,20,000", bracket: "₹5L – ₹8L", benefitPlan: "Senior Associate", status: "active", email: "nisha.kapoor@acme.com", phone: "9876543223", location: "Bengaluru" },
  { id: "EMP-015", name: "Rahul Khanna", initials: "RK", color: COLORS[14], department: "Product", designation: "VP", salary: "₹28,00,000", bracket: "₹25L+", benefitPlan: "VP", status: "active", email: "rahul.khanna@acme.com", phone: "9876543224", location: "Delhi" },
  { id: "EMP-016", name: "Pooja Rajan", initials: "PR", color: COLORS[0], department: "Human Resources", designation: "Associate", salary: "₹3,50,000", bracket: "₹2.5L – ₹5L", benefitPlan: "Associate", status: "active", email: "pooja.rajan@acme.com", phone: "9876543225", location: "Chennai" },
  { id: "EMP-017", name: "Suresh Kumar", initials: "SK", color: COLORS[1], department: "Finance", designation: "Senior Associate", salary: "₹5,50,000", bracket: "₹5L – ₹8L", benefitPlan: "Senior Associate", status: "on-leave", email: "suresh.kumar@acme.com", phone: "9876543226", location: "Jaipur" },
  { id: "EMP-018", name: "Kavitha Menon", initials: "KM", color: COLORS[2], department: "Engineering", designation: "Manager", salary: "₹9,00,000", bracket: "₹8L – ₹12L", benefitPlan: "Manager", status: "active", email: "kavitha.menon@acme.com", phone: "9876543227", location: "Thiruvananthapuram" },
  { id: "EMP-019", name: "Aditya Bhatt", initials: "AB", color: COLORS[3], department: "Marketing", designation: "Associate", salary: "₹3,20,000", bracket: "₹2.5L – ₹5L", benefitPlan: "Associate", status: "active", email: "aditya.bhatt@acme.com", phone: "9876543228", location: "Pune" },
  { id: "EMP-020", name: "Divya Rao", initials: "DR", color: COLORS[4], department: "Operations", designation: "AVP", salary: "₹22,00,000", bracket: "₹18L – ₹25L", benefitPlan: "AVP", status: "active", email: "divya.rao@acme.com", phone: "9876543229", location: "Bengaluru" },
];
...
export const DEMO_BRACKETS: SalaryBand[] = [
  {
    id: "bracket-assoc", name: "Associate", range: "₹2.5L – ₹5L", benefitPlan: "Associate", employeeCount: 4, expanded: false,
    benefits: [
      { name: "Food Allowance", enabled: true, maxPercent: "0", fixedCap: "2,000", billRequired: false, carryForward: false, category: "food" },
      { name: "Phone / Internet", enabled: true, maxPercent: "0", fixedCap: "800", billRequired: true, carryForward: false, category: "phone_internet" },
      { name: "Health & Fitness", enabled: true, maxPercent: "0", fixedCap: "1,500", billRequired: true, carryForward: false, category: "health_fitness" },
      { name: "Books & Periodicals", enabled: true, maxPercent: "0", fixedCap: "600", billRequired: true, carryForward: false, category: "books_periodicals" },
    ],
  },
  {
    id: "bracket-sr-assoc", name: "Senior Associate", range: "₹5L – ₹8L", benefitPlan: "Senior Associate", employeeCount: 5, expanded: false,
    benefits: [
      { name: "Food Allowance", enabled: true, maxPercent: "0", fixedCap: "3,000", billRequired: false, carryForward: false, category: "food" },
      { name: "Fuel Allowance", enabled: true, maxPercent: "0", fixedCap: "3,000", billRequired: true, carryForward: false, category: "fuel" },
      { name: "Phone / Internet", enabled: true, maxPercent: "0", fixedCap: "1,200", billRequired: true, carryForward: true, category: "phone_internet" },
      ...
      { name: "Health & Fitness", enabled: true, maxPercent: "0", fixedCap: "2,500", billRequired: true, carryForward: false, category: "health_fitness" },
      { name: "Books & Periodicals", enabled: true, maxPercent: "0", fixedCap: "1,000", billRequired: true, carryForward: false, category: "books_periodicals" },
    ],
  },
  {
    id: "bracket-mgr", name: "Manager", range: "₹8L – ₹12L", benefitPlan: "Manager", employeeCount: 4, expanded: false,
    benefits: [
  ...
  {
    id: "bracket-sr-mgr", name: "Senior Manager", range: "₹12L – ₹18L", benefitPlan: "Senior Manager", employeeCount: 3, expanded: false,
    benefits: [
      { name: "Food Allowance", enabled: true, maxPercent: "0", fixedCap: "6,000", billRequired: false, carryForward: false, category: "food" },
      { name: "Fuel Allowance", enabled: true, maxPercent: "0", fixedCap: "7,000", billRequired: true, carryForward: false, category: "fuel" },
      { name: "Phone / Internet", enabled: true, maxPercent: "0", fixedCap: "2,000", billRequired: true, carryForward: true, category: "phone_internet" },
      ...
      { name: "Professional Development", enabled: true, maxPercent: "0", fixedCap: "8,000", billRequired: true, carryForward: false, category: "professional_development" },
      { name: "Business Travel", enabled: true, maxPercent: "0", fixedCap: "10,000", billRequired: true, carryForward: true, category: "business_travel" },
      { name: "Books & Periodicals", enabled: true, maxPercent: "0", fixedCap: "2,000", billRequired: true, carryForward: false, category: "books_periodicals" },
    ],
  },
  {
    id: "bracket-avp", name: "Associate Vice President", range: "₹18L – ₹25L", benefitPlan: "AVP", employeeCount: 2, expanded: false,
    benefits: [
      { name: "Food Allowance", enabled: true, maxPercent: "0", fixedCap: "8,000", billRequired: false, carryForward: false, category: "food" },
      { name: "Fuel Allowance", enabled: true, maxPercent: "0", fixedCap: "10,000", billRequired: true, carryForward: false, category: "fuel" },
      { name: "Phone / Internet", enabled: true, maxPercent: "0", fixedCap: "2,500", billRequired: true, carryForward: true, category: "phone_internet" },
      { name: "Children's Education", enabled: true, maxPercent: "0", fixedCap: "6,000", billRequired: true, carryForward: true, category: "children_education" },
      { name: "Health & Fitness", enabled: true, maxPercent: "0", fixedCap: "6,000", billRequired: true, carryForward: false, category: "health_fitness" },
      { name: "Professional Development", enabled: true, maxPercent: "0", fixedCap: "12,000", billRequired: true, carryForward: false, category: "professional_development" },
  ...
  {
    id: "bracket-vp", name: "Vice President", range: "₹25L+", benefitPlan: "VP", employeeCount: 2, expanded: false,
    benefits: [
      { name: "Food Allowance", enabled: true, maxPercent: "0", fixedCap: "10,000", billRequired: false, carryForward: false, category: "food" },
      { name: "Fuel Allowance", enabled: true, maxPercent: "0", fixedCap: "15,000", billRequired: true, carryForward: false, category: "fuel" },
      { name: "Phone / Internet", enabled: true, maxPercent: "0", fixedCap: "3,000", billRequired: true, carryForward: true, category: "phone_internet" },
      { name: "Children's Education", enabled: true, maxPercent: "0", fixedCap: "8,000", billRequired: true, carryForward: true, category: "children_education" },
      { name: "Health & Fitness", enabled: true, maxPercent: "0", fixedCap: "8,000", billRequired: true, carryForward: false, category: "health_fitness" },
      { name: "Professional Development", enabled: true, maxPercent: "0", fixedCap: "15,000", billRequired: true, carryForward: false, category: "professional_development" },
      { name: "Business Travel", enabled: true, maxPercent: "0", fixedCap: "20,000", billRequired: true, carryForward: true, category: "business_travel" },
      { name: "Books & Periodicals", enabled: true, maxPercent: "0", fixedCap: "5,000", billRequired: true, carryForward: false, category: "books_periodicals" },
      { name: "Driver's Salary", enabled: true, maxPercent: "0", fixedCap: "12,000", billRequired: true, carryForward: true, category: "drivers_salary" },
      { name: "Vehicle Maintenance", enabled: true, maxPercent: "0", fixedCap: "8,000", billRequired: true, carryForward: true, category: "vehicle_maintenance" },
    ],
  },
];
